...
const PreventCard = () => {
  ...
  const cardResponsiveClass = `
    ...
    md:w-[140px] md:h-[280px] lg:w-[225px] lg:h-[315px]`;

  return (
    <div className="w-full grid md:grid-cols-5 justify-between p-4 bg-transparent gap-2 md:max-w-[760px] lg:max-w-[1240px] mx-auto">

      {/* CARD 1: PREVENT */}
      <div style={cardStyle} className={cardResponsiveClass}>
        ...
        <div className="relative z-30">
          <header className="flex items-center gap-2">
            <h5 className="text-white text-[14px] lg:text-[16px] font-medium">Prevent</h5>
            <span className="px-1.5 py-0.5 rounded-full bg-white text-[8px] font-bold text-black tracking-tight uppercase">NEW</span>
          </header>
          <p className="mt-2 lg:mt-4 text-[#97A3B6] text-[12px] lg:text-[14px] leading-relaxed">Stop friendly fraud, block digital shoplifters & prevent the next chargeback before it happens.</p>
        </div>
      ...
      <div style={cardStyle} className={cardResponsiveClass}>
        ...
        <div className="relative z-30">
          <h5 className="text-white text-[14px] lg:text-[16px] font-medium">Automation</h5>
          <p className="mt-2 lg:mt-4 text-[#97A3B6] text-[12px] lg:text-[14px] leading-relaxed">Fully automated chargeback recovery with 4x ROI guarantee.</p>
        </div>
        <span className={learnMoreSpanClass} style={{ backgroundColor: 'rgba(255, 255, 255, 0.12)' }}>Learn More</span>
      </div>
      ...
      <div style={cardStyle} className={cardResponsiveClass}>
        ...
        <div className="relative z-30">
          <h5 className="text-white text-[14px] lg:text-[16px] font-medium">Alerts</h5>
          <p className="mt-2 lg:mt-4 text-[#97A3B6] text-[12px] lg:text-[14px] leading-relaxed">Cut 90% of chargebacks before they happen, powered by Visa and Mastercard.</p>
        </div>
        <span className={learnMoreSpanClass} style={{ backgroundColor: 'rgba(255, 255, 255, 0.12)' }}>Learn More</span>
      </div>
      ...
      <div style={cardStyle} className={cardResponsiveClass}>
        ...
        <div className="absolute right-0 md:bottom-8 lg:bottom-0 w-full h-[280px] pointer-events-none z-20 transition-transform duration-700 ease-in-out">
          <Image src={insightsprimary} alt="" fill className="object-contain object-bottom grayscale opacity-100 transition-opacity duration-700 group-hover:opacity-0" />
          <Image src={insightsprimary} alt="" fill className="object-contain object-bottom opacity-0 group-hover:opacity-100 transition-opacity duration-700 z-50" />
          <div className="absolute inset-0 bg-gradient-to-t from-[#151515] via-transparent to-transparent z-30" />
        </div>
        <div className="relative z-[60]">
          <header className="flex items-center gap-2">
            <h5 className="text-white text-[14px] lg:text-[16px] font-medium">Insights</h5>
            <span className="px-1.5 py-0.5 rounded-full bg-gray-800 text-[8px] font-bold text-[#97A3B6] uppercase tracking-tight">FREE</span>
          </header>
          <p className="mt-2 lg:mt-4 text-[#97A3B6] text-[12px] lg:text-[14px] leading-relaxed">Get a bird's-eye view into your payments and chargebacks, all in a single, powerful dashboard.</p>
        </div>
        <span className={learnMoreSpanClass} style={{ backgroundColor: 'rgba(255, 255, 255, 0.12)' }}>Learn More</span>
      </div>
      ...
      <div style={cardStyle} className={cardResponsiveClass}>
        ...
        <div className="relative z-30">
          <header className="flex items-center gap-2">
            <h5 className="text-white text-[14px] lg:text-[16px] font-medium">Connect</h5>
          ...
          <p className="mt-2 lg:mt-4 text-[#97A3B6] text-[12px] lg:text-[14px] leading-relaxed">Integrate Chargeflow into your platform, either via Embedding, Whitelabel or API.</p>
        </div>
        <span className={learnMoreSpanClass} style={{ backgroundColor: 'rgba(255, 255, 255, 0.12)' }}>Learn More</span>
      </div>
