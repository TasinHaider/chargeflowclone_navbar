    ...
    <div className="flex w-full justify-between p-4 bg-transparent gap-2 font-inter max-w-[1240px] mx-auto">
      ...
      <div
        ...
        <div className="absolute botttom-0 right-0 w-full h-full pointer-events-none">
          <Image src={allcasesecondary} alt="allcasesecondary" fill className="object-contain grayscale opacity-100 transition-none" priority />
          <Image src={allcaseprimary} alt="allcaseprimary" fill className="object-contain opacity-0 group-hover:opacity-100 transition-opacity duration-700 z-20" priority />
      ...
      {/* CARD 2: OBVI */}
      <div style={cardStyle} className="group relative md:w-[140px] md:h-[280px] lg:w-[185px] lg:h-[315px] flex-shrink-0 p-6 rounded-2xl border border-white/[0.04] overflow-hidden cursor-pointer transition-all duration-500 hover:border-white/[0.12]" >
        <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 ease-in-out pointer-events-none z-10" style={blueGlowStyle} />
